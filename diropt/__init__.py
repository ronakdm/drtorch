...
from diropt._src.spectrums import compute_esrm_spectrum
from diropt._src.spectrums import compute_extremile_spectrum
from diropt._src.spectrums import compute_superquantile_spectrum
...
__all__ =[
  ...
  "compute_esrm_spectrum",
  "compute_extremile_spectrum",
  "compute_superquantile_spectrum"
]